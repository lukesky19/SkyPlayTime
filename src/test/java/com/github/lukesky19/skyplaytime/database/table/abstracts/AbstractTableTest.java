...
*/
package com.github.lukesky19.skyplaytime.database.table.abstracts;

import com.github.lukesky19.skyplaytime.SkyPlayTime;
import com.github.lukesky19.skyplaytime.common.DatabaseTestExtension;
...
public abstract class AbstractTableTest {
    @Mock
    protected SkyPlayTime skyPlayTime;
    ...
    public void setup(@NonNull TestInfo testInfo) {
        ...
        when(skyPlayTime.getDirectoryFile()).thenReturn(new File("test_data_" + this.getClass().getName() + "_" + displayName));

        // Set up the mocked queue manager
        mockedQueueManager = Mockito.mock(QueueManager.class);

        // Setup connection manager
        connectionManager = new ConnectionManager(skyPlayTime);
