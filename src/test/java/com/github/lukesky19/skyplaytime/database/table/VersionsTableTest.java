...
public class VersionsTableTest extends AbstractTableTest {
    ...
    public void setup(@NonNull TestInfo testInfo) {
        ...
        // Setup test class
        liveVersionsTable = new VersionsTable(logger, liveQueueManager);
        versionsTableWithMockedQueueManager = new VersionsTable(logger, mockedQueueManager);
    }
    ...
    public void testGetVersionError() {
        ...
        versionsTableWithMockedQueueManager.getVersion("test").join();
