...
*/
package com.github.lukesky19.skyplaytime.settings;
 ...
 * @param maxLocationHistoryCount The maximum number of locations to save per-player.
 * @param maxLocationAgeSeconds The maximum age in seconds to store a location snapshot for.
 ...
 * @param playerSettings The settings related to the player to be applied when they are marked as AFK.
...
public record Settings(
        ...
        int maxLocationHistoryCount,
        double maxLocationAgeSeconds,
