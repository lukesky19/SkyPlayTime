...
public class AddCommand {
    ...
    /**
     * Creates the {@link LiteralCommandNode} of type {@link CommandSourceStack} for the add command argument.
     * @return A {@link LiteralCommandNode} of type {@link CommandSourceStack}.
     */
    public LiteralCommandNode<CommandSourceStack> createCommand() {
        return Commands.literal("add")
                .requires(ctx -> ctx.getSender().hasPermission("skyplaytime.command.skyplaytime.add"))
