...
/**
 * This class is used to create the set command used to set a player's play time.
 */
public class SetCommand {
    ...
    /**
     * Creates the {@link LiteralCommandNode} of type {@link CommandSourceStack} for the set command argument.
     * @return A {@link LiteralCommandNode} of type {@link CommandSourceStack}.
     */
    public LiteralCommandNode<CommandSourceStack> createCommand() {
        return Commands.literal("set")
                .requires(ctx -> ctx.getSender().hasPermission("skyplaytime.command.skyplaytime.set"))
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("time", StringArgumentType.word())
                                        .executes(ctx -> {
                                            ...
                                            long timeToSet = TimeUtil.stringToMillis(ctx.getArgument("time", String.class)) / 1000;

                                            // Set the play time and then get the updated play time
                                            timeManager.setPlayTimeSeconds(targetUUID, TimeCategory.SESSION, timeToSet);
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("time", StringArgumentType.word())
                                        .executes(ctx -> {
                                            ...
                                            // Set the play time and then get the updated play time
                                            timeManager.setPlayTimeSeconds(targetUUID, TimeCategory.DAILY, timeToSet);
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("time", StringArgumentType.word())
                                        .executes(ctx -> {
                                            ...
                                            // Set the play time and then get the updated play time
                                            timeManager.setPlayTimeSeconds(targetUUID, TimeCategory.WEEKLY, timeToSet);
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("time", StringArgumentType.word())
                                        .executes(ctx -> {
                                            ...
                                            // Set the play time and then get the updated play time
                                            timeManager.setPlayTimeSeconds(targetUUID, TimeCategory.MONTHLY, timeToSet);
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("time", StringArgumentType.word())
                                        .executes(ctx -> {
                                            ...
                                            // Set the play time and then get the updated play time
                                            timeManager.setPlayTimeSeconds(targetUUID, TimeCategory.YEARLY, timeToSet);
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("time", StringArgumentType.word())
                                        .executes(ctx -> {
                                            ...
                                            // Set the play time and then get the updated play time
                                            timeManager.setPlayTimeSeconds(targetUUID, TimeCategory.TOTAL, timeToSet);
