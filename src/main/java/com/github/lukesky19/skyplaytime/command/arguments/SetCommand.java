                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("time", StringArgumentType.word())
                                        .executes(ctx -> {
                                            ...
                                            timeManager.setPlayTimeSeconds(target, TimeCategory.SESSION, timeToSet);
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("time", StringArgumentType.word())
                                        .executes(ctx -> {
                                            ...
                                            // Set the play time and then get the updated play time
                                            timeManager.setPlayTimeSeconds(target, TimeCategory.DAILY, timeToSet);
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("time", StringArgumentType.word())
                                        .executes(ctx -> {
                                            ...
                                            // Set the play time and then get the updated play time
                                            timeManager.setPlayTimeSeconds(target, TimeCategory.WEEKLY, timeToSet);
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("time", StringArgumentType.word())
                                        .executes(ctx -> {
                                            ...
                                            // Set the play time and then get the updated play time
                                            timeManager.setPlayTimeSeconds(target, TimeCategory.MONTHLY, timeToSet);
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("time", StringArgumentType.word())
                                        .executes(ctx -> {
                                            ...
                                            // Set the play time and then get the updated play time
                                            timeManager.setPlayTimeSeconds(target, TimeCategory.YEARLY, timeToSet);
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("time", StringArgumentType.word())
                                        .executes(ctx -> {
                                            ...
                                            // Set the play time and then get the updated play time
                                            timeManager.setPlayTimeSeconds(target, TimeCategory.TOTAL, timeToSet);
